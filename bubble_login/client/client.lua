...
function EnableGuiLogin(StatusGui) -- string 'StatusGui' can be true or false
	...
	ShutdownLoadingScreen()	-- Break LoadingScreen
	ShutdownLoadingScreenNui()	-- Break LoadingScreen Nui if exists
	TriggerEvent('esx:loadingScreenOff')	-- Trigger Event Shutdown Loadscreen
...
AddEventHandler('bubble_login:ValidMessageClientInChat', function( ValidMessage )
	...
	TriggerEvent("esx_multicharacter:SetupCharacters")	-- esx_multichar
end)
